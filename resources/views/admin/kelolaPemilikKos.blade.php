...
<div class="data-kos mt-2 p-6 bg-white rounded-2xl shadow-md">
    ...
    <div class="flex items-center justify-between mb-4">
        <!-- Tombol Tambah -->
        <a href="/admin/form/formKelolaPemilikKos" class="border border-[#17DD2B] bg-[#17DD2B] text-white px-4 py-2 rounded-full hover:bg-white hover:text-[#17DD2B] transition">
